            ...
            <div class="container py-5">
                <div class="row g-5">
                    <div class="col-lg-3 col-md-6">
                        ...
                        <p class="mb-2"><a href="mailto:anandamarg@gmail.com" class="text-white"><i class="fa fa-envelope me-3">  anandamarg@gmail.com</a></i></p>
